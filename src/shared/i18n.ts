...
const arabicText = {
  ...
  modules: {
    ...
    perfumeryText: "إدارة العطور، القوارير، الأحجام، والأسعار.",
    posTitle: "نقطة البيع",
    posText: "بيع سريع، دفع نقدي أو دين، وطباعة التذاكر.",
    revenueTitle: "المداخيل",
    revenueText: "متابعة المبيعات، الدفعات، المصاريف، والفائدة.",
    ...
    creditsTitle: "الدين",
    creditsText: "متابعة الزبائن، المبالغ المتبقية، والدفعات."
  },
